  ...
  <div class="container">
    <nav class="navbar navbar-expand-lg navbar-light" > <!--bg-light adiciona um bg cinza-->
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav"><!--justify-content-end adiciona o menu a direita -->
          <ul class="navbar-nav">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="http://localhost/somos_quatro_eletronicos/">Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/somos_quatro_eletronicos/sobre">Sobre</a>
            </li>
            <li class="nav-item">
